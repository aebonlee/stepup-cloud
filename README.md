...
학생의 학습 루틴, 독서, 활동 등의 데이터를 기록·시각화하여, 학부모와 함께 자기주도 학습의 방향을 설계하고 성장을 지원하는 협력형 학습관리 서비스입니다. (Backend : Render Cloud - 업데이트 2025.01.12)
...
- **백엔드**: Render (https://stepup-cloud-uh79.onrender.com)
